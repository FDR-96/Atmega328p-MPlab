...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Electrificador_Atmega328P.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Electrificador_Atmega328P.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega328P
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/8f2fd16722b50604dd2ed6d0a6a8fc7d01067d63.flag .generated_files/d8278ee61c4b2ee729e50eb83d08885c0c085ceb.flag
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/newmain.o: newmain.c  .generated_files/5fd7f2f6004127f0bc6bf2372cf9a2cefb6152d0.flag .generated_files/d8278ee61c4b2ee729e50eb83d08885c0c085ceb.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newmain.o.d 
	@${RM} ${OBJECTDIR}/newmain.o 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Electrificador_Atmega328P.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "dist/${CND_CONF}/${IMAGE_TYPE}/Electrificador_Atmega328P.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/Electrificador_Atmega328P.X.${IMAGE_TYPE}.hex"
endif
